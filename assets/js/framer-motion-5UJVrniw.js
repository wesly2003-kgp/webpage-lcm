...
function cr() {
    return gn || (gn = 1, ne.exports = ur()), ne.exports
}
var G = cr();
...
const ke = typeof window < "u",
    Fs = ke ? v.useLayoutEffect : v.useEffect,
    Uu = ({
        children: t,
        custom: e,
        initial: n = !0,
        ...
        const [a, l] = Ls(r), u = v.useMemo(() => yn(t), [t]), c = r && !a ? [] : u.map(Bt), h = v.useRef(!0), f = v.useRef(u), d = Fe(() => new Map), [p, m] = v.useState(u), [y, g] = v.useState(u);
        Fs(() => {
        ...
        if (u !== p) {
            ...
            o === "wait" && T.length && (b = T), g(yn(b)), m(u);
            return
        }
        const {
            forceRender: P
            ...
            children: y.map(b => {
                const x = Bt(b),
                    ...
                    M = () => {
                        ...
                        d.forEach(L => {
                            L || (A = !1)
                        }), A && (P == null || P(), g(f.current), r && (l == null || l()), s && s())
                    };
                return G.jsx(dr, {
                    isPresent: w,
...
function ks(t, e) {
    ...
    const i = {
        ...
        d = () => {
            ...
            n = !1, i.delta = s ? 1e3 / 60 : Math.max(Math.min(g - i.timestamp, yr), 1), i.timestamp = g, i.isProcessing = !0, a.process(i), l.process(i), u.process(i), c.process(i), h.process(i), f.process(i), i.isProcessing = !1, n && e && (s = !1, t(d))
        },
        p = () => {
...
const {
    ...
    state: E,
    steps: se
} = ks(typeof requestAnimationFrame < "u" ? requestAnimationFrame : j, !0), js = v.createContext({
    strict: !1
}), vn = {
...
const xr = new Set(["animate", "exit", "variants", "initial", "style", "values", "variants", "transition", "transformTemplate", "custom", "inherit", "onBeforeLayoutMeasure", "onAnimationStart", "onAnimationComplete", "onUpdate", "onDragStart", "onDrag", "onDragEnd", "onMeasureDragConstraints", "onDirectionLock", "onDragTransitionEnd", "_dragX", "_dragY", "onHoverStart", "onHoverEnd", "onViewportEnter", "onViewportLeave", "globalTapTarget", "ignoreStrict", "viewport"]);
...
function Zt(t) {
    return Yt(t.animate) || Ie.some(e => wt(t[e]))
}
...
const wr = Symbol.for("motionComponentSymbol");
...
function Dr(t, e, n, s, i) {
    ...
    const {
        visualElement: a
    } = v.useContext(qt), l = v.useContext(js), u = v.useContext(Xt), c = v.useContext(Be).reducedMotion, h = v.useRef(null);
    ...
    const f = h.current,
        d = v.useContext(_s);
    f && !f.projection && i && (f.type === "html" || f.type === "svg") && Mr(h.current, n, i, d);
    const p = v.useRef(!1);
    ...
    return Fs(() => {
        f && (p.current = !0, window.MotionIsMounted = !0, f.updateFeatures(), _e.render(f.render), y.current && f.animationState && f.animationState.animateChanges())
    }), v.useEffect(() => {
...
function Us(t) {
    if (t) return t.options.allowProjection !== !1 ? t.projection : Us(t.parent)
}
...
function Rr({
    ...
    function a(u, c) {
        ...
        if (!d && ke) {
            Lr();
            const y = Fr(f);
            h = y.MeasureLayout, p.visualElement = Dr(i, m, f, e, y.ProjectionNode)
        }
        return G.jsxs(qt.Provider, {
            value: p,
            children: [h && p.visualElement ? G.jsx(h, {
                visualElement: p.visualElement,
                ...f
            }) : null, n(i, u, Vr(m, p.visualElement, c), m, d, p.visualElement)]
        })
    }
...
const Br = ["animate", "circle", "defs", "desc", "ellipse", "g", "image", "line", "filter", "marker", "mask", "metadata", "path", "pattern", "polygon", "polyline", "rect", "stop", "switch", "symbol", "svg", "text", "tspan", "use", "view"];

function Ue(t) {
    return typeof t != "string" || t.includes("-") ? !1 : !!(Br.indexOf(t) > -1 || /[A-Z]/u.test(t))
}
...
const pt = ["transformPerspective", "x", "y", "z", "translateX", "translateY", "translateZ", "scale", "scaleX", "scaleY", "rotate", "rotateX", "rotateY", "rotateZ", "skew", "skewX", "skewY"],
    ...
    $s = Ws("--"),
    Nr = Ws("var(--"),
    We = t => Nr(t) ? _r.test(t.split("/*")[0].trim()) : !1,
    _r = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu,
...
function Ge(t, e, n) {
    ...
    if (e.transform || (r || n ? s.transform = Hr(e, t.transform, n) : s.transform && (s.transform = "none")), a) {
        const {
            originX: l = "50%",
            originY: u = "50%",
            originZ: c = 0
...
function ze(t, {
    ...
    f.transform && (p && (d.transform = f.transform), delete f.transform), p && (i !== void 0 || o !== void 0 || d.transform) && (d.transformOrigin = Zr(p, i !== void 0 ? i : .5, o !== void 0 ? o : .5)), e !== void 0 && (f.x = e), n !== void 0 && (f.y = n), s !== void 0 && (f.scale = s), r !== void 0 && Yr(f, r, a, l, !1)
}
const He = () => ({
        style: {},
        transform: {},
...
function Ys(t, {
    ...
    return it.has(t) || t.startsWith("origin") || (e || n !== void 0) && (!!Kt[t] || t === "opacity")
}
...
function qe(t, e, n) {
    ...
    for (const r in i)(B(i[r]) || e.style && B(e.style[r]) || Ys(r, t) || ((s = n == null ? void 0 : n.getValue(r)) === null || s === void 0 ? void 0 : s.liveStyle) !== void 0) && (o[r] = i[r]);
    return o
}
...
const bn = ["x", "y", "width", "height", "cx", "cy", "r"],
    to = {
        useVisualState: Ks({
            ...
            onUpdate: ({
                ...
                r && V.read(() => {
                    Qr(n, s), V.render(() => {
                        ze(s, i, Xe(n.tagName), t.transformTemplate), qs(n, s)
                    })
                })
            }
        })
...
function Js(t, e, n) {
    for (const s in e) !B(e[s]) && !Ys(s, n) && (t[s] = e[s])
}
...
function so(t, e) {
    const n = t.style || {},
        s = {};
    return Js(s, n, t), Object.assign(s, no(t, e)), s
}
...
function oo(t = !1) {
    return (n, s, i, {
        ...
        const l = (Ue(n) ? ro : io)(s, o, r, n),
            u = Pr(s, typeof n == "string", t),
            c = n !== v.Fragment ? { ...u,
                ...l,
                ref: i
            } : {},
...
const lo = je(() => window.ScrollTimeline !== void 0);
class uo {
    constructor(e) {
    ...
    attachTimeline(e, n) {
        const s = this.animations.map(i => {
            if (lo() && i.attachTimeline) return i.attachTimeline(e);
...
function fo(t, e) {
    ...
    return () => {
        var s;
        return (s = ho[e]) !== null && s !== void 0 ? s : n()
    }
}
const Wt = fo(() => {
        try {
...
function ni(t) {
    return !!(typeof t == "function" && Wt() || !t || typeof t == "string" && (t in ve || Wt()) || Je(t) || Array.isArray(t) && t.every(ni))
}
...
function si(t, e) {
    if (t) return typeof t == "function" && Wt() ? ei(t, e) : Je(t) ? vt(t) : Array.isArray(t) ? t.map(n => si(n, e) || ve.easeOut) : ve[t]
}
const U = {
    x: !1,
    y: !1
...
const oi = (t, e) => e ? t === e ? !0 : oi(t, e.parentElement) : !1,
    ...
    go = new Set(["BUTTON", "INPUT", "SELECT", "TEXTAREA", "A"]);

function yo(t) {
    return go.has(t.tagName) || t.tabIndex !== -1
}
...
function xo(t, e, n = {}) {
    const [s, i, o] = ri(t, n), r = a => {
        ...
        if (!Dn(a) || xt.has(l)) return;
        xt.add(l);
        const u = e(a),
            c = (d, p) => {
                window.removeEventListener("pointerup", h), window.removeEventListener("pointercancel", f), !(!Dn(d) || !xt.has(l)) && (xt.delete(l), typeof u == "function" && u(d, {
                    success: p
                }))
            },
            h = d => {
    ...
    return s.forEach(a => {
        !yo(a) && a.getAttribute("tabindex") === null && (a.tabIndex = 0), (n.useGlobalTarget ? window : a).addEventListener("pointerdown", r, i), a.addEventListener("focus", u => vo(u, i), i)
    }), o
}

function To(t) {
    return t === "x" || t === "y" ? U[t] ? null : (U[t] = !0, () => {
        U[t] = !1
    }) : U.x || U.y ? null : (U.x = U.y = !0, () => {
        U.x = U.y = !1
    })
}
...
const W = {
    now: () => (Nt === void 0 && W.set(E.isProcessing || mr.useManualTiming ? E.timestamp : performance.now()), Nt),
    set: t => {
        Nt = t, queueMicrotask(Po)
    }
};
...
class Ao {
    ...
    setCurrent(e) {
        this.current = e, this.updatedAt = W.now(), this.canTrackVelocity === null && e !== void 0 && (this.canTrackVelocity = So(this.current))
    }
...
function Mo(t, e, n, s, i) {
    let o, r, a = 0;
    do r = e + (n - e) / 2, o = ci(r, s, i) - t, o > 0 ? n = r : e = r; while (Math.abs(o) > Co && ++a < Do);
    return r
}

function Et(t, e, n, s) {
    if (t === e && n === s) return j;
    const i = o => Mo(o, 0, 1, t, n);
...
const Lo = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu,
    an = (t, e) => n => !!(typeof n == "string" && Lo.test(n) && n.startsWith(t) || e && !Eo(n) && Object.prototype.hasOwnProperty.call(n, e)),
    xi = (t, e, n) => s => {
    ...
    nt = {
        ...
        transform: ({
            ...
            blue: n,
            alpha: s = 1
        }) => "rgba(" + re.transform(t) + ", " + re.transform(e) + ", " + re.transform(n) + ", " + Pt(Vt.transform(s)) + ")"
    };
...
const Te = {
    ...
    at = {
        ...
        transform: ({
            ...
            lightness: n,
            alpha: s = 1
        }) => "hsla(" + Math.round(t) + ", " + K.transform(Pt(e)) + ", " + K.transform(Pt(n)) + ", " + Pt(Vt.transform(s)) + ")"
    },
    F = {
...
function jo(t) {
    var e, n;
    return isNaN(t) && typeof t == "string" && (((e = t.match(on)) === null || e === void 0 ? void 0 : e.length) || 0) + (((n = t.match(ko)) === null || n === void 0 ? void 0 : n.length) || 0) > 0
}
const Ti = "number",
    Pi = "color",
    Oo = "var",
...
function Dt(t) {
    const e = t.toString(),
        ...
        i = [];
    let o = 0;
    const a = e.replace(No, l => (F.test(l) ? (s.color.push(o), i.push(Pi), n.push(F.parse(l))) : l.startsWith(Io) ? (s.var.push(o), i.push(Oo), n.push(l)) : (s.number.push(o), i.push(Ti), n.push(parseFloat(l))), ++o, Rn)).split(Rn);
    return {
        values: n,
        split: a,
        indexes: s,
...
function Ai(t) {
    ...
    return i => {
        ...
        for (let r = 0; r < s; r++)
            if (o += e[r], i[r] !== void 0) {
                const a = n[r];
                a === Ti ? o += Pt(i[r]) : a === Pi ? o += F.transform(i[r]) : o += i[r]
            }
        return o
    }
}
const _o = t => typeof t == "number" ? 0 : t;

function Uo(t) {
    const e = Si(t);
    return Ai(t)(e.map(_o))
}
const Z = {
        test: jo,
        parse: Si,
...
function Ho(t, e, n) {
    ...
    for (; s < t.length && !i;) {
        const o = t[s];
        typeof o == "string" && !zo.has(o) && Dt(o).values.length && (i = t[s]), s++
    }
    if (i && n)
        for (const o of e) t[o] = bi(n, i)
}
const En = t => t === mt || t === S,
    Ln = (t, e) => parseFloat(t.split(", ")[e]),
    Fn = (t, e) => (n, {
        transform: s
    }) => {
        if (s === "none" || !s) return 0;
        const i = s.match(/^matrix3d\((.+)\)$/u);
        if (i) return Ln(i[1], e); {
            const o = s.match(/^matrix\((.+)\)$/u);
            return o ? Ln(o[1], t) : 0
        }
    },
    Xo = new Set(["x", "y", "z"]),
    qo = pt.filter(t => !Xo.has(t));
...
class Ei extends un {
    ...
    resolveNoneKeyframes() {
        ...
        for (let i = 0; i < e.length; i++) Ro(e[i]) && s.push(i);
        s.length && Ho(e, s, n)
    }
    measureInitialState() {
        const {
...
const kn = (t, e) => e === "zIndex" ? !1 : !!(typeof t == "number" || Array.isArray(t) || typeof t == "string" && (Z.test(t) || t === "0") && !t.startsWith("url("));
...
function na(t, e, n, s) {
    ...
    const o = t[t.length - 1],
        r = kn(i, e),
        a = kn(o, e);
    return !r || !a ? !1 : ea(t) || (n === "spring" || Ze(n)) && s
}
const sa = t => t !== null;
...
class Li {
    ...
    get resolved() {
        return !this._resolved && !this.hasAttemptedResolve && Zo(), this._resolved
    }
...
const On = (t, e) => {
        ...
        return o => (i.red = ae(n.red, s.red, o), i.green = ae(n.green, s.green, o), i.blue = ae(n.blue, s.blue, o), i.alpha = C(n.alpha, s.alpha, o), nt.transform(i))
    },
    la = (t, e) => n => e(t(n)),
    Lt = (...t) => t.reduce(la),
...
function cn(t) {
    return typeof t == "number" ? ca : typeof t == "string" ? We(t) ? $t : F.test(t) ? On : da : Array.isArray(t) ? Fi : typeof t == "object" ? F.test(t) ? On : ha : $t
}
...
const da = (t, e) => {
    const n = Z.createTransformer(e),
        s = Dt(t),
        i = Dt(e);
    return s.indexes.var.length === i.indexes.var.length && s.indexes.color.length === i.indexes.color.length && s.indexes.number.length >= i.indexes.number.length ? be.has(t) && !i.values.length || be.has(e) && !s.values.length ? ua(t, e) : Lt(Fi(fa(s, i), i.values), n) : $t(t, e)
};
...
function ya(t, e, n) {
    let s = n;
    for (let i = 1; i < ga; i++) s = s - t(s) / e(s);
    return s
}
...
const Pa = Et(.42, 0, 1, 1),
    Sa = Et(0, 0, .58, 1),
    Oi = Et(.42, 0, .58, 1),
    Aa = t => Array.isArray(t) && typeof t[0] != "number",
    ba = {
        linear: j,
        easeIn: Pa,
        easeInOut: Oi,
    ...
    _n = t => {
        if (Je(t)) {
            ...
            const [e, n, s, i] = t;
            return Et(e, n, s, i)
        } else if (typeof t == "string") return ba[t];
        return t
    };
...
function Va(t, e, {
    ...
    const o = t.length;
    if (Bs(o === e.length), o === 1) return () => e[0];
...
function Gt({
    ...
    const i = Aa(s) ? s.map(_n) : _n(s),
        o = {
            done: !1,
            value: e[0]
        },
        r = Ma(n && n.length === e.length ? n : Da(e), t),
        a = Va(r, e, {
...
class hn extends Li {
    constructor(e) {
        ...
        const {
            ...
            element: i,
            keyframes: o
        } = this.options, r = (i == null ? void 0 : i.KeyframeResolver) || un, a = (l, u) => this.onKeyframesResolved(l, u);
    ...
    initPlayback(e) {
        const {
            ...
            repeatType: o,
            velocity: r = 0
        } = this.options, a = Ze(n) ? n : La[n] || Gt;
        let l, u;
        a !== Gt && typeof e[0] != "number" && (l = Lt(Fa, Bi(e[0], e[1])), e = [0, 100]);
...
const ja = je(() => Object.hasOwnProperty.call(Element.prototype, "animate")),
    zt = 10,
    Oa = 2e4;
...
function Na(t, e) {
    ...
    const i = [];
    let o = 0;
    for (; !s.done && o < Oa;) s = n.sample(o), i.push(s.value), o += zt;
    return {
        times: void 0,
        keyframes: i,
        duration: o - zt,
...
class Un extends Li {
    ...
    initPlayback(e, n) {
        ...
        if (typeof o == "string" && Wt() && _a(o) && (o = Ii[o]), Ia(this.options)) {
            const {
                onComplete: h,
                onUpdate: f,
                motionValue: d,
    ...
    stop() {
        ...
        if (this.time) {
            ...
            u.setWithVelocity(p.sample(m - zt).value, p.sample(m).value, zt)
        }
        const {
            onStop: l
        } = this.options;
    ...
    static supports(e) {
        ...
        return ja() && s && Ba.has(s) && !l && !u && !i && o !== "mirror" && r !== 0 && a !== "inertia"
    }
}
const Ua = {
        type: "spring",
    ...
    Ga = (t, {
        keyframes: e
    }) => e.length > 2 ? Wa : it.has(t) ? t.startsWith("scale") ? Ka(e[1]) : Ua : $a;
    ...
    function r(l) {
        ...
        for (let y = 0; y < Qa; y++) {
            ...
            if (w && s && t.manuallyAnimateOnMount && (w = !1), T.protectedKeys = { ...d
                }, !T.isActive && x === null || !P && !T.prevProp || Yt(P) || typeof P == "boolean") continue;
            const M = nl(T.prevProp, P);
            ...
            const {
                ...
                A = !0, f.has(k) && (L = !0, f.delete(k)), T.needsAnimating[k] = !0;
                const $ = t.getValue(k);
                $ && ($.liveStyle = !1)
            };
            for (const k in ar) {
                ...
                let ee = !1;
                ge($) && ge(te) ? ee = !Qs($, te) : ee = $ !== te, ee ? $ != null ? pn(k) : f.add(k) : $ !== void 0 && f.has(k) ? pn(k) : T.protectedKeys[k] = !0
            }
            T.prevProp = P, T.prevResolvedValues = rt, T.isActive && (d = { ...d,
                ...rt
            }), s && t.blockInitialAnimation && (A = !1), A && (!(w && M) || L) && h.push(...I.map(k => ({
                animation: k,
                options: {
                    type: g
                }
...
function St(t, e, n, s) {
    return Mt(t, e, al(n), s)
}
const Wn = (t, e) => Math.abs(t - e);
...
class Ui {
    constructor(e, n, {
        ...
        if (this.startEvent = null, this.lastMoveEvent = null, this.lastMoveEventInfo = null, this.handlers = {}, this.contextWindow = window, this.updatePoint = () => {
                ...
                const h = ce(this.lastMoveEventInfo, this.history),
        ...
        const r = Ft(e),
            a = ue(r, this.transformPagePoint),
            {
                point: l
            } = a,
            {
        ...
        c && c(e, ce(a, this.history)), this.removeListeners = Lt(St(this.contextWindow, "pointermove", this.handlePointerMove), St(this.contextWindow, "pointerup", this.handlePointerUp), St(this.contextWindow, "pointercancel", this.handlePointerUp))
    }
    updateHandlers(e) {
        this.handlers = e
    }
...
function Gn(t, e, n, s = .5) {
    t.origin = s, t.originPoint = C(e.min, e.max, t.origin), t.scale = O(n) / O(e), t.translate = C(n.min, n.max, t.origin) - t.originPoint, (t.scale >= hl && t.scale <= fl || isNaN(t.scale)) && (t.scale = 1), (t.translate >= dl && t.translate <= pl || isNaN(t.translate)) && (t.translate = 0)
}
...
function Xi(t, e) {
    return Gi(bl(t.getBoundingClientRect(), e))
}
...
class Dl {
    ...
    start(e, {
        ...
        const i = c => {
            ...
            o = (c, h) => {
                ...
                if (f && !d && (this.openDragLock && this.openDragLock(), this.openDragLock = To(f), !this.openDragLock)) return;
            ...
            r = (c, h) => {
                ...
                if (d && this.currentDirection === null) {
                    this.currentDirection = Ml(y), this.currentDirection !== null && p && p(this.currentDirection);
                    return
                }
    ...
    resolveConstraints() {
        ...
        n && ot(n) ? this.constraints || (this.constraints = this.resolveRefConstraints()) : n && i ? this.constraints = vl(i.layoutBox, n) : this.constraints = !1, this.elastic = Sl(s), o !== this.constraints && i && this.constraints && !this.hasMutatedConstraints && _(r => {
            this.constraints !== !1 && this.getAxisMotionValue(r) && (this.constraints[r] = Pl(i.layoutBox[r], this.constraints[r]))
        })
    }
    resolveRefConstraints() {
        ...
        const o = Vl(s, i.root, this.visualElement.getTransformPagePoint());
        let r = xl(i.layout.layoutBox, o);
        if (n) {
            const a = n(Al(r));
    ...
    startAnimation(e) {
        ...
        } = this.getProps(), l = this.constraints || {}, u = _(c => {
    ...
    addListeners() {
        ...
        const r = Mt(window, "resize", () => this.scalePositionWithinConstraints()),
...
class Rl extends J {
    constructor(e) {
        super(e), this.removeGroupControls = j, this.removeListeners = j, this.controls = new Dl(e)
    }
    mount() {
        const {
            dragControls: e
...
class Fl extends v.Component {
    componentDidMount() {
        ...
        Jr(Bl), o && (n.group && n.group.add(o), s && s.register && i && s.register(o), o.root.didUpdate(), o.addEventListener("animationComplete", () => {
            this.safeToRemove()
    ...
    componentDidUpdate() {
        ...
        e && (e.root.didUpdate(), _e.postRender(() => {
...
function Yi(t) {
    const [e, n] = Ls(), s = v.useContext(Le);
    return G.jsx(Fl, { ...t,
        layoutGroup: s,
        switchLayoutGroup: v.useContext(_s),
        isPresent: e,
        safeToRemove: n
    })
}
...
const Zi = ["TopLeft", "TopRight", "BottomLeft", "BottomRight"],
    ...
    ls = t => typeof t == "number" || S.test(t);

function Ul(t, e, n, s, i, o) {
    i ? (t.opacity = C(0, n.opacity !== void 0 ? n.opacity : 1, Kl(s)), t.opacityExit = C(e.opacity !== void 0 ? e.opacity : 1, 0, Wl(s))) : o && (t.opacity = C(e.opacity !== void 0 ? e.opacity : 1, n.opacity !== void 0 ? n.opacity : 1, s));
    for (let r = 0; r < _l; r++) {
        const a = `border${Zi[r]}Radius`;
        let l = us(e, a),
            u = us(n, a);
        if (l === void 0 && u === void 0) continue;
        l || (l = 0), u || (u = 0), l === 0 || u === 0 || ls(l) === ls(u) ? (t[a] = Math.max(C(as(l), as(u), s), 0), (K.test(u) || K.test(l)) && (t[a] += "%")) : t[a] = u
...
function ps(t, e, n, s) {
    ds(t.x, e, Gl, n ? n.x : void 0, s ? s.x : void 0), ds(t.y, e, zl, n ? n.y : void 0, s ? s.y : void 0)
}
    ...
    return class {
        constructor(r = {}, a = e == null ? void 0 : e()) {
            this.id = Zl++, this.animationId = 0, this.children = new Set, this.options = {}, this.isTreeAnimating = !1, this.isAnimationBlocked = !1, this.isLayoutDirty = !1, this.isProjectionDirty = !1, this.isSharedProjectionDirty = !1, this.isTransformDirty = !1, this.updateManuallyBlocked = !1, this.updateBlockedByResize = !1, this.isUpdating = !1, this.isSVG = !1, this.needsReset = !1, this.shouldResetTransform = !1, this.hasCheckedOptimisedAppear = !1, this.treeScale = {
                ...
                this.projectionUpdateScheduled = !1, Tt && (et.totalNodes = et.resolvedTargetDeltas = et.recalculatedProjection = 0), this.nodes.forEach(tu), this.nodes.forEach(ru), this.nodes.forEach(ou), this.nodes.forEach(eu), Tt && window.MotionDebug.record(et)
        ...
        mount(r, a = this.root.hasTreeAnimated) {
            ...
            this.isSVG = jl(r), this.instance = r;
            const {
                layoutId: l,
                layout: u,
                visualElement: c
            ...
            if (c && !c.current && c.mount(r), this.root.nodes.add(this), this.parent && this.parent.children.add(this), a && (u || l) && (this.isLayoutDirty = !0), t) {
                ...
                t(r, () => {
                    this.root.updateBlockedByResize = !0, h && h(), h = Nl(f, 250), _t.hasAnimatedSinceResize && (_t.hasAnimatedSinceResize = !1, this.nodes.forEach(Ss))
                })
            }
            l && this.root.registerSharedNode(l, this), this.options.animate !== !1 && c && (l || u) && this.addEventListener("didUpdate", ({
                ...
                const m = this.options.transition || c.getDefaultTransition() || hu,
                    {
                ...
                } else f || Ss(this), this.isLead() && this.options.onExitComplete && this.options.onExitComplete();
                this.targetLayout = p
            })
        }
        unmount() {
        ...
        update() {
            ...
            this.isUpdating || this.nodes.forEach(su), this.isUpdating = !1, this.nodes.forEach(iu), this.nodes.forEach(Jl), this.nodes.forEach(Ql), this.clearAllSnapshots();
            const a = W.now();
        ...
        clearAllSnapshots() {
            this.nodes.forEach(nu), this.sharedNodes.forEach(lu)
        }
        ...
        measurePageBox() {
            ...
            if (!(((r = this.scroll) === null || r === void 0 ? void 0 : r.wasRoot) || this.path.some(du))) {
                const {
                    scroll: c
                } = this.root;
        ...
        resolveTargetDelta(r = !1) {
            ...
            if (!(!this.layout || !(h || f))) {
                if (this.resolvedRelativeTargetAt = E.timestamp, !this.targetDelta && !this.relativeTarget) {
                    ...
                    d && d.layout && this.animationProgress !== 1 ? (this.relativeParent = d, this.forceRelativeParentToResolveTarget(), this.relativeTarget = R(), this.relativeTargetOrigin = R(), bt(this.relativeTargetOrigin, this.layout.layoutBox, d.layout.layoutBox), N(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
                }
                if (!(!this.relativeTarget && !this.targetDelta)) {
                    if (this.target || (this.target = R(), this.targetWithTransforms = R()), this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target ? (this.forceRelativeParentToResolveTarget(), gl(this.target, this.relativeTarget, this.relativeParent.target)) : this.targetDelta ? (this.resumingFrom ? this.target = this.applyTransform(this.layout.layoutBox) : N(this.target, this.layout.layoutBox), Hi(this.target, this.targetDelta)) : N(this.target, this.layout.layoutBox), this.attemptToResolveRelativeTarget) {
                        this.attemptToResolveRelativeTarget = !1;
                        const d = this.getClosestProjectingParent();
                        d && !!d.resumingFrom == !!this.resumingFrom && !d.options.layoutScroll && d.target && this.animationProgress !== 1 ? (this.relativeParent = d, this.forceRelativeParentToResolveTarget(), this.relativeTarget = R(), this.relativeTargetOrigin = R(), bt(this.relativeTargetOrigin, this.target, d.target), N(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
                    }
                    Tt && et.resolvedTargetDeltas++
                }
            }
        }
        ...
        calcProjection() {
            ...
            const f = this.treeScale.x,
                d = this.treeScale.y;
            wl(this.layoutCorrected, this.treeScale, this.path, l), a.layout && !a.target && (this.treeScale.x !== 1 || this.treeScale.y !== 1) && (a.target = a.layout.layoutBox, a.targetWithTransforms = R());
            const {
                target: p
            } = a;
            if (!p) {
                ...
                return
            }!this.projectionDelta || !this.prevProjectionDelta ? this.createProjectionDeltas() : (hs(this.prevProjectionDelta.x, this.projectionDelta.x), hs(this.prevProjectionDelta.y, this.projectionDelta.y)), At(this.projectionDelta, this.layoutCorrected, p, this.latestValues), (this.treeScale.x !== f || this.treeScale.y !== d || !xs(this.projectionDelta.x, this.prevProjectionDelta.x) || !xs(this.projectionDelta.y, this.prevProjectionDelta.y)) && (this.hasProjected = !0, this.scheduleRender(), this.notifyListeners("projectionUpdate", p)), Tt && et.recalculatedProjection++
        }
        hide() {
            this.isVisible = !1
        }
        ...
        setAnimationOrigin(r, a = !1) {
            ...
            const f = R(),
                ...
                T = !!(m && !g && this.options.crossfade === !0 && !this.path.some(cu));
            this.animationProgress = 0;
            let P;
            this.mixTargetDelta = b => {
                const x = b / 1e3;
                As(h.x, r.x, x), As(h.y, r.y, x), this.setTargetDelta(h), this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout && (bt(f, this.layout.layoutBox, this.relativeParent.layout.layoutBox), uu(this.relativeTarget, this.relativeTargetOrigin, f, x), P && Hl(this.relativeTarget, P) && (this.isProjectionDirty = !1), P || (P = R()), N(P, this.relativeTarget)), m && (this.animationValues = c, Ul(c, u, this.latestValues, x, T, g)), this.root.scheduleUpdateProjection(), this.scheduleRender(), this.animationProgress = x
        ...
        startAnimation(r) {
            this.notifyListeners("animationStart"), this.currentAnimation && this.currentAnimation.stop(), this.resumingFrom && this.resumingFrom.currentAnimation && this.resumingFrom.currentAnimation.stop(), this.pendingAnimation && (Y(this.pendingAnimation), this.pendingAnimation = void 0), this.pendingAnimation = V.update(() => {
                _t.hasAnimatedSinceResize = !0, this.currentAnimation = kl(0, Ts, { ...r,
                    onUpdate: a => {
        ...
        registerSharedNode(r, a) {
            this.sharedNodes.has(r) || this.sharedNodes.set(r, new Xl), this.sharedNodes.get(r).add(a);
        ...
        getProjectionStyles(r) {
            ...
            if (!this.projectionDelta || !this.layout || !h.target) {
                const m = {};
                return this.options.layoutId && (m.opacity = this.latestValues.opacity !== void 0 ? this.latestValues.opacity : 1, m.pointerEvents = It(r == null ? void 0 : r.pointerEvents) || ""), this.hasProjected && !tt(this.latestValues) && (m.transform = c ? c({}, "") : "none", this.hasProjected = !1), m
            }
            ...
            for (const m in Kt) {
                ...
                const {
                    correct: y,
                    applyTo: g
                } = Kt[m], T = u.transform === "none" ? f[m] : y(f[m], h);
                if (g) {
                    const P = g.length;
        ...
        if (!t.resumeFrom) {
            ...
            if (h && !h.resumeFrom) {
                ...
                if (f && d) {
                    ...
                    const m = R();
                    bt(m, s, d.layoutBox), tr(p, m) || (c = !0), h.options.layoutRoot && (t.relativeTarget = m, t.relativeTargetOrigin = p, t.relativeParent = h)
                }
            }
        }
...
function tu(t) {
    Tt && et.totalNodes++, t.parent && (t.isProjecting() || (t.isProjectionDirty = t.parent.isProjectionDirty), t.isSharedProjectionDirty || (t.isSharedProjectionDirty = !!(t.isProjectionDirty || t.parent.isProjectionDirty || t.parent.isSharedProjectionDirty)), t.isTransformDirty || (t.isTransformDirty = t.parent.isTransformDirty))
}
...
const hu = {
    ...
    ws = t => typeof navigator < "u" && navigator.userAgent && navigator.userAgent.toLowerCase().includes(t),
    Vs = ws("applewebkit/") && !ws("chrome/") ? Math.round : j;
...
function sr(t, e, n) {
    return t === "position" || t === "preserve-aspect" && !ml(vs(e), vs(n), .2)
}
...
class gu extends J {
    mount() {
        ...
        e && (this.unmount = mo(e, n => (Ds(this.node, n, "Start"), s => Ds(this.node, s, "End"))))
    }
    unmount() {}
}
class yu extends J {
    ...
    mount() {
        this.unmount = Lt(Mt(this.node.current, "focus", () => this.onFocus()), Mt(this.node.current, "blur", () => this.onBlur()))
    }
    unmount() {}
}
...
class vu extends J {
    mount() {
        ...
        e && (this.unmount = xo(e, n => (Ms(this.node, n, "Start"), (s, {
            success: i
        }) => Ms(this.node, s, i ? "End" : "Cancel")), {
...
function Pu({
    ...
    const s = me.get(n),
        i = JSON.stringify(e);
    return s[i] || (s[i] = new IntersectionObserver(Tu, {
        root: t,
        ...e
    })), s[i]
}
...
const Es = ["AnimationStart", "AnimationComplete", "Update", "BeforeLayoutMeasure", "LayoutMeasure", "LayoutAnimationStart", "LayoutAnimationComplete"];
class Lu {
    ...
    constructor({
        ...
        for (const d in f) {
            const p = f[d];
            l[d] !== void 0 && B(p) && p.set(l[d], !1)
        }
    }
    mount(e) {
        this.current = e, Rs.set(e, this), this.projection && !this.projection.instance && this.projection.mount(e), this.parent && this.isVariantNode && !this.isControllingVariants && (this.removeFromVariantTree = this.parent.addVariantChild(this)), this.values.forEach((n, s) => this.bindToMotionValue(s, n)), rr.current || Du(), this.shouldReduceMotion = this.reducedMotionConfig === "never" ? !1 : this.reducedMotionConfig === "always" ? !0 : Ee.current, this.parent && this.parent.children.add(this), this.update(this.props, this.presenceContext)
    }
    unmount() {
        Rs.delete(this.current), this.projection && this.projection.unmount(), Y(this.notifyUpdate), Y(this.render), this.valueSubscriptions.forEach(e => e()), this.valueSubscriptions.clear(), this.removeFromVariantTree && this.removeFromVariantTree(), this.parent && this.parent.children.delete(this);
        for (const e in this.events) this.events[e].clear();
    ...
    update(e, n) {
        ...
        this.prevMotionValues = Eu(this, this.scrapeMotionValuesFromProps(e, this.prevProps, this), this.prevMotionValues), this.handleChildMotionValue && this.handleChildMotionValue(), this.onUpdate && this.onUpdate(this)
    }
    getProps() {
        return this.props
    }
    ...
    readValue(e, n) {
        ...
        return i != null && (typeof i == "string" && (Ci(i) || vi(i)) ? i = parseFloat(i) : !Ru(i) && Z.test(n) && (i = bi(e, n)), this.setBaseTarget(e, B(i) ? i.get() : i)), B(i) ? i.get() : i
    }
    setBaseTarget(e, n) {
        this.baseTarget[e] = n
    }
    getBaseTarget(e) {
        ...
        return o !== void 0 && !B(o) ? o : this.initialValues[e] !== void 0 && i === void 0 ? void 0 : this.baseTarget[e]
    }
    on(e, n) {
...
const ju = (t, e) => Ue(t) ? new ku(e) : new Bu(e, {
